	...
	({
        ...
        ${
			stableActive
				...
				: "bg-transparent text-app-fg hover:bg-app-accent-hover hover:text-app-bg"
		}
      `)}
...
function Navbar() {
	...
	return (
		<nav className="fixed z-20 left-1/2 transform -translate-x-1/2 top-4 rounded-4xl bg-white/15 border border-app-fg/20 backdrop-blur-md backdrop-filter flex">
			{navItems.map((item) => {
